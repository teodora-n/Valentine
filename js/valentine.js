...
setTimeout(function(){ 	
	...
	//Validate the form and submit the tweet
	$('#submit').click(function(e){
		var name = $('#name').val();
		if( !$('#name').val() ) {
			$('#msg').velocity('fadeIn', {duration:300});
		} else {
			$(this).attr('href', 'http://twitter.com/home?status=@'+ name +' Happy Saint Valentine! Here is a Valentine for you ❤ via Tweet I love you http://www.teodora-dev.com/valentine/ @teodora76279859'); 
			$('#msg').hide();
		}
	});
